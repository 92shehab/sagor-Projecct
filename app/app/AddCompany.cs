    ...
    public partial class AddCompany : Form
    {
        ...
        public void InsertData(SQLiteConnection conn, string shopname, string mobilenumber, string shopaddress)
        {
            ...
            if (count == 0)
            {
                ...
                sqlite_cmd.CommandText = "INSERT INTO Company(ShopName, ShopMobileNumber,ShopAddress ) VALUES('" + shopname + "','" + mobilenumber + "','" + shopaddress + "') ";
        ...
        public void DeleteData(SQLiteConnection conn, string id)
        {
            ...
            SQLiteCommand sqlite_cmd;
            sqlite_cmd = conn.CreateCommand();
            sqlite_cmd.CommandText = "DELETE FROM Company WHERE ShopId='" + id + "'";
            sqlite_cmd.ExecuteNonQuery();
        }
        ...
        {
            DialogResult dr = MessageBox.Show("Are you sure to delete Company?", "Confirmation", MessageBoxButtons.YesNo);
        ...
        public void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentRow != null) {
                ...
                sqlite_cmd.CommandText = "UPDATE Company SET ShopName = '" + shopname + "', ShopMobileNumber = '" + mobilenumber + "',ShopAddress = '" + shopaddress + "' WHERE ShopId = '" + shopid + "'";
                sqlite_cmd.ExecuteNonQuery();
