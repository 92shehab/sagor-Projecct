...
namespace app
{
    public partial class ShopMemo : Form
    {
        ...
        public ShopMemo()
        {
           ...
           /* if (comboBox1.Items != null) {
            ...
            label15.Text = "Total Cost" + " - " + " Cash Received " ;
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sqlite_cmd.CommandText = "SELECT * FROM Shop where ShopName='" + shopname + "'"; 
        ...
        public void InsertData(SQLiteConnection conn,int shopid,string shopname,string memoDate, string doNumber,double quantity,string productType, double unitprice, double totalproductprice, double truckcost, double othercost, double totacost, double cashreceived, double duebalance,int dueflag)
        {
            ...
            SQLiteCommand sqlite_cmd;
            sqlite_cmd = conn.CreateCommand();
            sqlite_cmd.CommandText = "INSERT INTO ShopMemo(ShopId,ShopName,MemoDate,DONumber,ProductQuantity,ProductType,UnitPrice,ProductPrice,TruckCost,OtherCost,TotalCost,CashReceived,DueBalance,DueFlag) VALUES('" + shopid + "','" + shopname + "','" + memoDate + "','" + doNumber + "','" + quantity + "','" + productType + "','" + unitprice + "','" + totalproductprice + "','" + truckcost + "','" + othercost + "','" + totacost + "','" + cashreceived + "','" + duebalance + "','" + dueflag + "') ";
        ...
        public void ReadData(SQLiteConnection conn)
        {
            ...
            SQLiteCommand sqlite_cmd;
            sqlite_cmd = conn.CreateCommand();
            sqlite_cmd.CommandText = "SELECT * FROM ShopMemo WHERE MemoDate='" + memoDate + "'"; 
            ...
            label25.Text = "Total Cash Received : " + totalCashreceivedtext;
